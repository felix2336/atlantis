import { Client, ClientOptions, Collection, PollAnswerData, PollData, PollLayoutType, PollQuestionMedia, RoleResolvable } from 'discord.js';
...
export declare class SlashCommand<ClientType extends ExtendedClient = ExtendedClient> {
    ...
    autocomplete: ISlashCommand<ClientType>["autocomplete"];
...
export declare class ExtendedClient extends Client {
    ...
    deployCommands(...guildIdOrIds: string[]): void;
