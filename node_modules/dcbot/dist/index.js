...
exports.ExtendedClient = exports.Modal = exports.MentionableSelectMenu = exports.UserSelectMenu = exports.ChannelSelectMenu = exports.RoleSelectMenu = exports.StringSelectMenu = exports.Button = exports.MessageContextMenu = exports.UserContextMenu = exports.SlashCommand = exports.Event = exports.Poll = void 0;
...
class ExtendedClient extends discord_js_1.Client {
    ...
    loadCommands(path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const files = (0, fs_1.readdirSync)(path).filter(f => f.endsWith('.ts') || f.endsWith('.js'));
...
//     member: GuildMember
//     guild: Guild
//     private constructor(member: GuildMember, guild: Guild) {
//         this.member = member
//         this.guild = guild
//     }
